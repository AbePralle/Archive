#ifndef BARD_STDLIB_H
#define BARD_STDLIB_H
//=============================================================================
//  bard_stdlib.h
//
...
/*
extern BardReal64 Bard_pi;

struct BardParseReader
{
  BardTypeInfo* type;
  BardInt32     line, column, pos, remaining, spaces_per_tab;
  BardArray*    array;
};
*/

struct BardProcess : BardObject
{
  BardInt32   exit_code;
  BardLogical is_active;
};
...
BardString* bard_file_absolute_filepath( BardString* filepath );
void        bard_file_rename( BardString* filepath, BardString* new_name );
void        bard_file_delete( BardString* filepath );
bool        bard_get_file_timestamp( const char* filepath, BardInt64* timestamp ); 
BardInt64   bard_file_timestamp( BardString* filepath );
void        bard_file_touch( BardString* filepath );
void        bard_file_change_dir( BardString* filepath );
