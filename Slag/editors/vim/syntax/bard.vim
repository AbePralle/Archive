...
" keyword definitions
syn keyword bardClassDecl   class endClass aspect endAspect compound endCompound enum endEnum
syn keyword bardClassDecl   with endWith
syn keyword bardClassDecl   augment endAugment framework endFramework
syn keyword bardMember      CLASS_PROPERTIES CLASS_VARS CLASS_METHODS PROPERTIES VARS METHODS
syn keyword bardMember      BASE_TYPES CATEGORIES ENUMERATE SINGLETONS
...
syn keyword bardStatement    return breakpoint necessary sufficient removeCurrent noAction
syn keyword bardSpecial      breakpoint insertUnderlying
syn keyword bardType         Int64 Int32 Byte Char Real64 Real32 Logical null var
syn keyword bardStorageClass overlaying underlying
syn keyword bardScopeDecl    readOnly writeOnly public private limited const local delegate
syn keyword bardScopeDecl    deferred singleton managed
syn keyword bardStorageClass native requisite abstract final propagated runtime
...
syn keyword bardFuncDef  method multimethod
