...
public class BossParseReader
{
  ...
  public BossParseReader()
  {
  }

  public BossParseReader( String filename, String data )
  {
    init( filename, data );
  }

  public BossParseReader( String filename )
  {
    init( filename );
  }
  ...
  public void init( String filename )
  {
    ...
    {
      throw new BossError( "Cannot open \"" + filename + "\" for reading." );
    }
  }
