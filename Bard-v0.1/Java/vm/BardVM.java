...
public class BardVM
{
  ...
  public void organize()
  {
    ...
    type_Real_wrapper    = must_find_type( "RealProperty" );
    type_Integer_wrapper = must_find_type( "IntegerProperty" );
    type_Character_wrapper    = must_find_type( "CharacterProperty" );
    type_Logical_wrapper = must_find_type( "LogicalProperty" );
