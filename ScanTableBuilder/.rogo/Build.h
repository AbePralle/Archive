...
struct RogueClassFunction_558; // Function_558
...
struct RogueClassFunction_594; // Function_594
...
struct RogueClassFunction_1663; // Function_1663
...
struct RogueClassFunction_558 : RogueObject
{
  // PROPERTIES
...
{
  // PROPERTIES
  RogueClassStringTable_String_* rogo_syntax;
  RogueClassStringTable_String_* rogo_descriptions;
  RogueString* rogo_prefix;
  RogueString* rogo_command;
  RogueClassValueList* rogo_args;
  RogueClassError* rogo_error;
  RogueString* LOCAL_DEFS_FILE;
...
struct RogueClassFunction_594 : RogueObject
{
  // PROPERTIES
...
struct RogueClassFunction_1663 : RogueObject
{
  // PROPERTIES
...
extern RogueType* RogueTypeFunction_558;
...
extern RogueType* RogueTypeFunction_594;
...
extern RogueType* RogueTypeFunction_1663;
...
ROGUE_EXPORT_C RogueString* RogueFile__absolute_filepath__String( RogueString* _auto_2786 );
ROGUE_EXPORT_C RogueLogical RogueFile__create_folder__String( RogueString* _auto_2787 );
...
ROGUE_EXPORT_C RogueLogical RogueFile__exists__String( RogueString* _auto_2788 );
ROGUE_EXPORT_C RogueString* RogueFile__expand_filepath__String( RogueString* _auto_2789 );
ROGUE_EXPORT_C RogueString* RogueFile__filename__String( RogueString* _auto_2790 );
ROGUE_EXPORT_C RogueString* RogueFile__fix_slashes__String( RogueString* filepath_0 );
ROGUE_EXPORT_C RogueString* RogueFile__folder__String( RogueString* _auto_2791 );
ROGUE_EXPORT_C RogueLogical RogueFile__is_folder__String( RogueString* _auto_2792 );
...
ROGUE_EXPORT   RogueString_List* RogueFile__listing__String_FileOptions( RogueString* _auto_2793, RogueClassFileOptions options_1 );
ROGUE_EXPORT   RogueString_List* RogueFile__listing__String_FileOptions_String_String_List( RogueString* _auto_2794, RogueClassFileOptions options_1, RogueString* _auto_2795, RogueString_List* result_3 );
ROGUE_EXPORT_C RogueLogical RogueFile__matches_wildcard_pattern__String_String( RogueString* _auto_2796, RogueString* pattern_1 );
...
ROGUE_EXPORT_C RogueClassFileReader* RogueFile__reader__String( RogueString* _auto_2797 );
ROGUE_EXPORT_C RogueCharacter RogueFile__separator();
ROGUE_EXPORT_C RogueReal64 RogueFile__timestamp__String( RogueString* _auto_2798 );
...
ROGUE_EXPORT_C void RogueGlobal__rogo_go( RogueClassGlobal* THIS );
ROGUE_EXPORT_C void RogueGlobal__rogo_build( RogueClassGlobal* THIS );
ROGUE_EXPORT_C void RogueGlobal__rogo_execute( RogueClassGlobal* THIS );
ROGUE_EXPORT_C RogueLogical RogueGlobal__execute__String_Logical( RogueClassGlobal* THIS, RogueString* commands_0, RogueLogical suppress_error_1 );
...
ROGUE_EXPORT_C void RogueGlobal__rogo_help__String( RogueClassGlobal* THIS, RogueString* _auto_2799 );
...
ROGUE_EXPORT_C RogueTypeInfo* RogueTypeInfo__init__Int32_String( RogueTypeInfo* THIS, RogueInt32 _auto_323_0, RogueString* _auto_324_1 );
...
ROGUE_EXPORT_C RogueClassPropertyInfo* RoguePropertyInfo__init__Int32_Int32_Int32( RogueClassPropertyInfo* THIS, RogueInt32 _auto_412_0, RogueInt32 _auto_413_1, RogueInt32 _auto_414_2 );
...
ROGUE_EXPORT_C RogueClassMethodInfo* RogueMethodInfo__init__Int32_Int32_Int32_Int32_Int32_Int32( RogueClassMethodInfo* THIS, RogueInt32 _auto_588_0, RogueInt32 _auto_589_1, RogueInt32 _auto_590_2, RogueInt32 _auto_591_3, RogueInt32 _auto_592_4, RogueInt32 _auto_593_5 );
...
ROGUE_EXPORT_C RogueClassValue* RogueMethodInfo__call__Value( RogueClassMethodInfo* THIS, RogueClassValue* _auto_2800 );
...
ROGUE_EXPORT_C RogueClassIntrospector* RogueIntrospector__init__Object( RogueClassIntrospector* THIS, RogueObject* _auto_361_0 );
ROGUE_EXPORT_C RogueClassIntrospector* RogueIntrospector__init__Object_Int64_TypeInfo( RogueClassIntrospector* THIS, RogueObject* _auto_362_0, RogueInt64 _auto_363_1, RogueTypeInfo* _auto_364_2 );
...
ROGUE_EXPORT_C RogueClassValueList* RogueValueList__clear( RogueClassValueList* THIS );
...
ROGUE_EXPORT_C RogueString_List* RogueTable_String_Value___keys__String_List( RogueClassTable_String_Value_* THIS, RogueString_List* _auto_2801 );
...
ROGUE_EXPORT_C RogueClassObjectValue* RogueObjectValue__init__Object( RogueClassObjectValue* THIS, RogueObject* _auto_415_0 );
...
ROGUE_EXPORT_C RogueClassStringReader* RogueStringReader__init__String( RogueClassStringReader* THIS, RogueString* _auto_440_0 );
...
ROGUE_EXPORT_C RogueClassFunction_558* RogueFunction_558__init_object( RogueClassFunction_558* THIS );
ROGUE_EXPORT_C RogueString* RogueFunction_558__type_name( RogueClassFunction_558* THIS );
ROGUE_EXPORT_C void RogueFunction_558__call( RogueClassFunction_558* THIS );
...
ROGUE_EXPORT_C RogueClassFiles* RogueFiles__init__String( RogueClassFiles* THIS, RogueString* _auto_2802 );
...
ROGUE_EXPORT_C RogueClassLineReader* RogueLineReader__init__Reader_Character_( RogueClassLineReader* THIS, RogueClassReader_Character_* _auto_574_0 );
...
ROGUE_EXPORT_C void RogueBuild__launch( RogueClassBuild* THIS );
ROGUE_EXPORT_C void RogueBuild__dispatch_command( RogueClassBuild* THIS );
ROGUE_EXPORT_C RogueClassMethodInfo* RogueBuild__find_command__String( RogueClassBuild* THIS, RogueString* name_0 );
ROGUE_EXPORT_C void RogueBuild__on_error( RogueClassBuild* THIS );
ROGUE_EXPORT_C void RogueBuild__on_command_found( RogueClassBuild* THIS );
ROGUE_EXPORT_C void RogueBuild__on_command_not_found( RogueClassBuild* THIS );
ROGUE_EXPORT_C void RogueBuild__on_launch( RogueClassBuild* THIS );
ROGUE_EXPORT_C void RogueBuild__on_exit( RogueClassBuild* THIS );
ROGUE_EXPORT_C void RogueBuild__parse_args( RogueClassBuild* THIS );
ROGUE_EXPORT_C void RogueBuild__read_local_defs( RogueClassBuild* THIS );
ROGUE_EXPORT_C void RogueBuild__read_local_defs__String( RogueClassBuild* THIS, RogueString* defs_filepath_0 );
ROGUE_EXPORT_C RogueString* RogueBuild___join__Value( RogueClassBuild* THIS, RogueClassValue* value_0 );
...
ROGUE_EXPORT_C RogueClassFunction_594* RogueFunction_594__init_object( RogueClassFunction_594* THIS );
ROGUE_EXPORT_C RogueString* RogueFunction_594__type_name( RogueClassFunction_594* THIS );
ROGUE_EXPORT_C RogueLogical RogueFunction_594__call__String_String( RogueClassFunction_594* THIS, RogueString* a_0, RogueString* b_1 );
...
ROGUE_EXPORT_C RogueClassLogicalValue* RogueLogicalValue__init__Logical( RogueClassLogicalValue* THIS, RogueLogical _auto_959_0 );
...
ROGUE_EXPORT_C RogueClassInt32Value* RogueInt32Value__init__Int32( RogueClassInt32Value* THIS, RogueInt32 _auto_960_0 );
...
ROGUE_EXPORT_C RogueClassInt64Value* RogueInt64Value__init__Int64( RogueClassInt64Value* THIS, RogueInt64 _auto_961_0 );
...
ROGUE_EXPORT_C RogueClassReal64Value* RogueReal64Value__init__Real64( RogueClassReal64Value* THIS, RogueReal64 _auto_962_0 );
...
ROGUE_EXPORT_C RogueClassStringValue* RogueStringValue__init__String( RogueClassStringValue* THIS, RogueString* _auto_964_0 );
...
ROGUE_EXPORT   RogueClassOptionalBoxed_Int32_* RogueOptionalBoxed_Int32___init__OptionalInt32( RogueClassOptionalBoxed_Int32_* THIS, RogueOptionalInt32 _auto_1578_0 );
...
ROGUE_EXPORT_C RogueClassOptionalBoxedIntrospector_Int32_* RogueOptionalBoxedIntrospector_Int32___init__Object( RogueClassOptionalBoxedIntrospector_Int32_* THIS, RogueObject* _auto_1579_0 );
...
ROGUE_EXPORT_C RogueClassFunction_1663* RogueFunction_1663__init_object( RogueClassFunction_1663* THIS );
ROGUE_EXPORT_C RogueString* RogueFunction_1663__type_name( RogueClassFunction_1663* THIS );
ROGUE_EXPORT_C void RogueFunction_1663__call( RogueClassFunction_1663* THIS );
ROGUE_EXPORT_C RogueClassFunction_1663* RogueFunction_1663__init__Console( RogueClassFunction_1663* THIS, RogueClassConsole* _auto_1664_0 );
...
ROGUE_EXPORT   RogueClassOptionalBoxed_Byte_* RogueOptionalBoxed_Byte___init__OptionalByte( RogueClassOptionalBoxed_Byte_* THIS, RogueOptionalByte _auto_1669_0 );
...
ROGUE_EXPORT_C RogueClassOptionalBoxedIntrospector_Byte_* RogueOptionalBoxedIntrospector_Byte___init__Object( RogueClassOptionalBoxedIntrospector_Byte_* THIS, RogueObject* _auto_1670_0 );
...
ROGUE_EXPORT_C RogueLogical RogueFileReader__open__String( RogueClassFileReader* THIS, RogueString* _auto_1778_0 );
...
ROGUE_EXPORT_C RogueClassUTF8Reader* RogueUTF8Reader__init__Reader_Byte_( RogueClassUTF8Reader* THIS, RogueClassReader_Byte_* _auto_1818_0 );
...
ROGUE_EXPORT   RogueClassBoxed_SystemEnvironment_* RogueBoxed_SystemEnvironment___init__SystemEnvironment( RogueClassBoxed_SystemEnvironment_* THIS, RogueClassSystemEnvironment _auto_1820_0 );
...
ROGUE_EXPORT_C RogueClassBoxedIntrospector_SystemEnvironment_* RogueBoxedIntrospector_SystemEnvironment___init__Object( RogueClassBoxedIntrospector_SystemEnvironment_* THIS, RogueObject* _auto_1821_0 );
...
ROGUE_EXPORT   RogueClassOptionalBoxed_Character_* RogueOptionalBoxed_Character___init__OptionalCharacter( RogueClassOptionalBoxed_Character_* THIS, RogueOptionalCharacter _auto_2306_0 );
...
ROGUE_EXPORT_C RogueClassOptionalBoxedIntrospector_Character_* RogueOptionalBoxedIntrospector_Character___init__Object( RogueClassOptionalBoxedIntrospector_Character_* THIS, RogueObject* _auto_2307_0 );
...
ROGUE_EXPORT   RogueClassOptionalBoxed_Value_* RogueOptionalBoxed_Value___init__OptionalValue( RogueClassOptionalBoxed_Value_* THIS, RogueOptionalValue _auto_2315_0 );
...
ROGUE_EXPORT_C RogueClassOptionalBoxedIntrospector_Value_* RogueOptionalBoxedIntrospector_Value___init__Object( RogueClassOptionalBoxedIntrospector_Value_* THIS, RogueObject* _auto_2316_0 );
...
ROGUE_EXPORT   RogueClassOptionalBoxed_Real64_* RogueOptionalBoxed_Real64___init__OptionalReal64( RogueClassOptionalBoxed_Real64_* THIS, RogueOptionalReal64 _auto_2399_0 );
...
ROGUE_EXPORT_C RogueClassOptionalBoxedIntrospector_Real64_* RogueOptionalBoxedIntrospector_Real64___init__Object( RogueClassOptionalBoxedIntrospector_Real64_* THIS, RogueObject* _auto_2400_0 );
...
ROGUE_EXPORT   RogueClassBoxed_FileOptions_* RogueBoxed_FileOptions___init__FileOptions( RogueClassBoxed_FileOptions_* THIS, RogueClassFileOptions _auto_2486_0 );
...
ROGUE_EXPORT_C RogueClassBoxedIntrospector_FileOptions_* RogueBoxedIntrospector_FileOptions___init__Object( RogueClassBoxedIntrospector_FileOptions_* THIS, RogueObject* _auto_2487_0 );
...
ROGUE_EXPORT_C RogueException* RogueException__init__String( RogueException* THIS, RogueString* _auto_241_0 );
...
ROGUE_EXPORT_C RogueClassOutOfBoundsError* RogueOutOfBoundsError__init__String( RogueClassOutOfBoundsError* THIS, RogueString* _auto_687_0 );
