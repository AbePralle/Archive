...
//import ishottheserif.SlagFontImage;
...
//	public static final boolean isDebugging = true;
	...
	public static final Dimension MIN_SIZE = new Dimension( 1024, 480 );
	...
	private JPanel fontControlStrip;
		...
		private JSpinner leftPadSpinner;	
		private JSpinner rightPadSpinner;	

		private JSpinner fontSizeSpinner;	
		public final int FONT_MAX_SIZE = 288;
	...
	public MainFrame(){
		...
		int fontLeftPad = (Integer)leftPadSpinner.getValue();
		int fontRightPad = (Integer)rightPadSpinner.getValue();
		fontViewer.setFontImage( new SlagFontImage( currentFont, 
				imageType, fontString, fontColor, renderingHints, fontLeftPad, fontRightPad ).getImage() );
	...
	public JPanel createFontControlStrip(){
		...
		fontControlStrip.add( createLeftPadSpinner() );
		fontControlStrip.add( createRightPadSpinner() );
	...
	//--------------------------------------------------------------------------
	/**
	 * creates the left padding spinner 
	 * @return the JSpinner control created 
	 *///-----------------------------------------------------------------------
	public JSpinner createRightPadSpinner(){
		
		SpinnerNumberModel model = new SpinnerNumberModel(0, 0, 200, 1);
		rightPadSpinner = new JSpinner( model );
		rightPadSpinner.setToolTipText( 
				"Increase (Ctrl+Up) or decrease (Ctrl+Down) the right padding");
		
		rightPadSpinner.addChangeListener( this );
		rightPadSpinner.addKeyListener( this );
			
		return rightPadSpinner;
	}
	 ...
	 * @return the JSpinner control created 
	 *///-----------------------------------------------------------------------
	public JSpinner createLeftPadSpinner(){
		
		SpinnerNumberModel model = new SpinnerNumberModel(0, 0, 200, 1);
		leftPadSpinner = new JSpinner( model );
		leftPadSpinner.setToolTipText( 
				"Increase (Ctrl+Up) or decrease (Ctrl+Down) the left padding");
		
		leftPadSpinner.addChangeListener( this );
		leftPadSpinner.addKeyListener( this );
			
		return leftPadSpinner;
	}
    ...
    String defaultFilename = "font_" + currentFont.getName() 
    	+ "_" + (fontViewer.getFontImage().getHeight()-1)
    ...
    if( chooser.showSaveDialog( this ) == JFileChooser.APPROVE_OPTION ){
    	...
    	try {
    		BufferedImage fontImage = new SlagFontImage( 
  				...
  				renderingHints, fontLeftPad, fontRightPad ).getImage();
