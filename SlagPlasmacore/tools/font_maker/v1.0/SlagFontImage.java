...
//	public static final boolean isDebugging = true;
	...
	public class FontCharacterShapeMap
		...
		public FontCharacterShapeMap( 
				String fontStr, Font font, Graphics2D gfx ){
			...
			FontCharacterShape fcd = new FontCharacterShape( c, font, gfx );
			put( c, fcd );
			int lastWidth = fcd.getWidth();
			
			for( int i = 1; i < fontStr.length(); i++ ){
				c = fontStr.charAt( i );
				fcd = new FontCharacterShape( c, font, gfx );
				put( c, fcd );
	...
	public class FontCharacterShape {
		 ...
		 *///-----------------------------------------------------------------
		public FontCharacterShape( char c, Font font, Graphics2D gfx ){
			debugln( "" + c );
	...
	public SlagFontImage(
		...
		FontCharacterShapeMap dimMap = 
			new FontCharacterShapeMap( fontString, font, gfx );
